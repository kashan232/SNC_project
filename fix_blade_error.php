...
// Find the exact cart block by searching for '<div class="sinlge-bar shopping"'
// that contains 'cartCount()'.
$start = strpos($header, '<div class="sinlge-bar shopping"', strpos($header, 'cartCount()') - 500);
$end = strpos($header, '</div>', strpos($header, '@endauth', $start)) + 6;
$cart_html = substr($header, $start, $end - $start);
