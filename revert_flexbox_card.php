...
.our-products-area .single-product {
    ...
    padding: 15px 15px 85px 15px !important; /* 85px space at the bottom for buttons */
    border: none !important;
    margin-bottom: 30px !important;
    position: relative !important; /* Anchor for buttons */
}
...
.our-products-area .single-product .product-img {
    ...
    position: static !important; /* VERY IMPORTANT: lets buttons escape out of image */
...
/* Buttons Area (Placed strictly at the bottom) */
.our-products-area .single-product .button-head {
    background: transparent !important;
    opacity: 1 !important;
    visibility: visible !important;
    position: absolute !important; /* Anchored to .single-product */
...
echo "Restored strict absolute positioning design.";
