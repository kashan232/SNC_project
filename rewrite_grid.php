											...
											@foreach(\$menu as \$cat_info)
                                                <li>
                                                    <a href="{{route('product-cat',\$cat_info->slug)}}" class="{{ Request::is('product-cat/'.\$cat_info->slug) ? 'active' : '' }}">
                                                        <span class="cat-icon">
                                                            <!-- Map some icons based on category names if possible, else generic -->
                                                            @if(stripos(\$cat_info->title, 'nimco') !== false) <i class="ti-pie-chart"></i>
                                                            @elseif(stripos(\$cat_info->title, 'biscuit') !== false) <i class="ti-slice"></i>
                                                            @elseif(stripos(\$cat_info->title, 'sweet') !== false) <i class="ti-gift"></i>
                                                            @else <i class="ti-tag"></i> @endif
                                                        </span>
...
echo "Completely rewrote product-grids.blade.php!";
