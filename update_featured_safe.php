...
// Fix the exact string to avoid regex matching other parts of the document
$old_title = '<span style="color: var(--primary-color); font-weight: 700; text-transform: uppercase; letter-spacing: 2px; font-size: 14px;">Top Picks</span>
...
$new_title = '<span style="color: #A3ADB9; font-weight: 600; text-transform: uppercase; letter-spacing: 2px; font-size: 12px;">FEATURED ARRIVALS</span>
                      <h2 style="font-family: \'Playfair Display\', serif; font-size: 40px; font-weight: 500; color: #EAE6DF; margin-top: 10px;">Featured Arrivals</h2>';

$c = str_replace($old_title, $new_title, $c);

file_put_contents('c:/xampp/htdocs/SNC_project/resources/views/frontend/index.blade.php', $c);
echo "Featured Products UI updated safely.\n";
