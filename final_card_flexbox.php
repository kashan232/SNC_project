...
/* Card Design using Flexbox for perfect flow */
.our-products-area .single-product {
    ...
    position: relative !important; /* For the heart button */
    display: flex !important;
    flex-direction: column !important;
}

/* Flatten the product-img so its children become flex items */
.our-products-area .single-product .product-img {
    display: contents !important;
}

/* Apply the white box styling to the image anchor tag instead */
.our-products-area .single-product .product-img > a:first-child {
    ...
    justify-content: center !important;
    order: 1 !important; /* 1st position */
}
...
.our-products-area .single-product .product-content {
    ...
    order: 2 !important; /* 2nd position (middle) */
    flex-grow: 1 !important; /* Push buttons to bottom if heights vary */
    display: flex !important;
    flex-direction: column !important;
    justify-content: center !important;
}
...
.our-products-area .single-product .button-head {
    order: 3 !important; /* 3rd position (bottom) */
    background: transparent !important;
    opacity: 1 !important;
...
.our-products-area .single-product .product-action a[title="Wishlist"] {
    position: absolute !important; /* Break out of flexbox order */
    top: 25px !important;
...
echo "Applied robust flexbox layout for cards.";
