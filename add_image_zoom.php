...
.our-products-area .single-product {
    ...
    transition: all 0.4s ease-in-out !important; /* Smooth transition for hover */
}

/* PREMIUM CARD HOVER EFFECT (Safe for layout) */
...
.our-products-area .single-product .product-img {
    ...
    overflow: hidden !important; /* Keeps the zooming image inside the white box */
}
.our-products-area .single-product .product-img img {
    width: 100% !important;
    height: auto !important;
    object-fit: cover !important;
    transition: transform 0.4s ease-in-out !important; /* Smooth zoom transition */
}
...
/* IMAGE ZOOM ON HOVER (Safe for layout) */
.our-products-area .single-product:hover .product-img img {
    transform: scale(1.08) !important; /* Slight zoom in */
}

/* Hide the secondary hover image */
.our-products-area .single-product .product-img .hover-img {
    display: none !important;
}
.our-products-area .single-product:hover .product-img .default-img {
    opacity: 1 !important;
...
echo "Image zoom animation added.";
