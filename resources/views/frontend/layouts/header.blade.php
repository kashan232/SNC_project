...
.cart-item-content h4 { margin-bottom: 3px !important; } .cart-item-content p { margin: 0; }</style>
...
.shopping-list li .remove { position: relative; top: auto; left: auto;
    position: absolute;
    top: 0;
    left: 0;
    color: #ff4757;
...
.shopping-list li .cart-img { position: relative; margin-left: 5px; margin-right: 0;
    width: 60px;
    height: 60px;
    border-radius: 8px;
    overflow: hidden;
